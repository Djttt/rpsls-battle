...
import { Trophy, Medal, AlertCircle, X } from 'lucide-react';
...
export const Leaderboard: React.FC<LeaderboardProps> = ({ onClose }) => {
    ...
    return (
        <div className="bg-slate-900 border border-slate-700 rounded-xl p-6 w-full max-w-md mx-auto shadow-2xl relative">
            {onClose && (
